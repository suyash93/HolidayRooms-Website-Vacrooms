...
<div class="container">
  <div class="row">
    <div class="col-lg-12">
      <div class="jumbotron">
        <h1 class="text-center">Present Users</h1>
...
<div class="container">
  <div class="row">
<p><a class="btn btn-primary btn-lg" href="fulldata.php" role="button">Users of this Website</a> </p>
<p><a class="btn btn-primary btn-lg" href="curl.php" role="button">Users from all Websites</a> </p>
...
<p>
  ...
  <hr>
<footer class="text-center" id="New Users">
  <div class="container">
    <div class="row">
      <div class="col-xs-12">
