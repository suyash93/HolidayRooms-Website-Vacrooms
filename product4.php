<?php 
  ...
  else{setcookie("latestfive[1st]", "product4", time()+60*60*24*7);}
  if(isset($_COOKIE["latestfive"])&&$_COOKIE["latestfive"]["1st"]!="product4"){
    switch (count($_COOKIE["latestfive"])) {
      case 1:
        setcookie("latestfive[1st]", "product4", time()+60*60*24*7);
        setcookie("latestfive[2nd]", $_COOKIE['latestfive']['1st'], time()+60*60*24*7);
        break;
      case 2:
        if($_COOKIE["latestfive"]['2nd']=="product4"){
          setcookie("latestfive[1st]", "product4", time()+60*60*24*7);
          setcookie("latestfive[2nd]", $_COOKIE['latestfive']['1st'], time()+60*60*24*7);
        }else{
          setcookie("latestfive[1st]", "product4", time()+60*60*24*7);
      ...
      case 3:
        if($_COOKIE["latestfive"]['2nd']=="product4"){
          setcookie("latestfive[1st]", "product4", time()+60*60*24*7);
          setcookie("latestfive[2nd]", $_COOKIE['latestfive']['1st'], time()+60*60*24*7);
        }else if($_COOKIE["latestfive"]['3rd']=="product4"){
          setcookie("latestfive[1st]", "product4", time()+60*60*24*7);
          setcookie("latestfive[2nd]", $_COOKIE['latestfive']['1st'], time()+60*60*24*7);
          setcookie("latestfive[3rd]", $_COOKIE['latestfive']['2nd'], time()+60*60*24*7);
        }else{
      ...
      case 4:
        if($_COOKIE["latestfive"]['2nd']=="product4"){
          ...
          setcookie("latestfive[2nd]", $_COOKIE['latestfive']['1st'], time()+60*60*24*7);
          setcookie("latestfive[3rd]", $_COOKIE['latestfive']['2nd'], time()+60*60*24*7);
        }else if($_COOKIE["latestfive"]['4th']=="product4"){
          setcookie("latestfive[1st]", "product4", time()+60*60*24*7);
          setcookie("latestfive[2nd]", $_COOKIE['latestfive']['1st'], time()+60*60*24*7);
          setcookie("latestfive[3rd]", $_COOKIE['latestfive']['2nd'], time()+60*60*24*7);
          setcookie("latestfive[4th]", $_COOKIE['latestfive']['3rd'], time()+60*60*24*7);
...
<img src="/palace2.jpg" alt="" class="img-responsive"> </div>
    </div>
  </div>
</div>
<div class="container">
...
<p>Looking for a grand vacroom with all the facilities and a royal decor??</p>
<p>Well that's the correct choice you opted for. </p>
